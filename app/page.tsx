...
{stage.draft_message}
      ...
      {/* Demo / Sample scan — real output from sellsniper.com scanning itself */}
      <section id="demo" className="max-w-4xl mx-auto px-6 py-20 border-t border-zinc-900">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">See what you get</h2>
          <p className="text-zinc-400 max-w-2xl mx-auto">
            A real scan of <span className="text-zinc-200 font-mono">sellsniper.com</span> — top stages and drafts in 19 seconds. Slice of the actual output below.
          </p>
        </div>

        <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-950 max-w-3xl mx-auto text-left">
          <div className="text-xs uppercase tracking-wider text-zinc-500 mb-2">Target</div>
          <div className="text-lg font-semibold mb-4">SellSniper — AI distribution agent for indie makers</div>
          <div className="grid sm:grid-cols-2 gap-4 text-sm mb-6">
            <div>
              <div className="text-zinc-500 text-xs mb-1">Problem solved</div>
              <div className="text-zinc-300">Indie makers fail at distribution because they don&apos;t know where their audience hangs out.</div>
            </div>
            <div>
              <div className="text-zinc-500 text-xs mb-1">Audience</div>
              <div className="text-zinc-300">Indie hackers, bootstrapped founders, solo creators launching products.</div>
            </div>
          </div>

          <div className="text-xs uppercase tracking-wider text-zinc-500 mb-3">Top 3 of 10 stages · ranked by fit</div>
          <div className="space-y-4">
            <div className="border border-zinc-800 rounded-lg p-4 bg-black">
              <div className="flex items-start justify-between gap-4 mb-2">
                <div>
                  <div className="text-xs text-red-400 uppercase tracking-wider mb-1">indiehackers</div>
                  <div className="font-semibold text-white">Indie Hackers community feed</div>
                </div>
                <div className="text-xs text-zinc-600 font-mono">#1</div>
              </div>
              <div className="text-sm text-zinc-400 mb-3">Core audience of makers actively solving distribution problems.</div>
              <pre className="whitespace-pre-wrap text-sm text-zinc-200 font-sans">Built SellSniper to solve the distribution problem I kept hitting. You paste a link, it finds the 10+ communities where your actual users hang out and drafts messages that don&apos;t feel spammy. Free tier gives you 3 scans/day.</pre>
            </div>

            <div className="border border-zinc-800 rounded-lg p-4 bg-black">
              <div className="flex items-start justify-between gap-4 mb-2">
                <div>
                  <div className="text-xs text-red-400 uppercase tracking-wider mb-1">reddit</div>
                  <div className="font-semibold text-white">r/SideProject</div>
                </div>
                <div className="text-xs text-zinc-600 font-mono">#2</div>
              </div>
              <div className="text-sm text-zinc-400 mb-3">Makers sharing side projects actively need distribution help.</div>
              <pre className="whitespace-pre-wrap text-sm text-zinc-200 font-sans">I built SellSniper to stop shouting into the void with my own projects. It reverse-engineers what you made, finds the humans who&apos;d actually care (Reddit, Twitter, Discord, forums), and drafts messages per audience.</pre>
            </div>

            <div className="border border-zinc-800 rounded-lg p-4 bg-black">
              <div className="flex items-start justify-between gap-4 mb-2">
                <div>
                  <div className="text-xs text-red-400 uppercase tracking-wider mb-1">forum</div>
                  <div className="font-semibold text-white">Hacker News (Show HN)</div>
                </div>
                <div className="text-xs text-zinc-600 font-mono">#7</div>
              </div>
              <div className="text-sm text-zinc-400 mb-3">HN audience values meta-tools for makers and distribution innovation.</div>
              <pre className="whitespace-pre-wrap text-sm text-zinc-200 font-sans">Show HN: SellSniper – Find the exact communities and humans who&apos;d care about your project. Paste any URL (product, essay, app, demo), and SellSniper reverse-engineers what it is, scans Reddit/Twitter/Discord/forums for matching audiences, and drafts tailored messages per community.</pre>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="px-6 py-3 border border-zinc-700 rounded-lg hover:border-red-500 hover:text-white text-zinc-300 transition-colors cursor-pointer"
          >
            Try yours →
          </button>
        </div>
      ...
      <section id="pricing" className="max-w-4xl mx-auto px-6 py-20 border-t border-zinc-900">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <div className="border border-red-500 rounded-xl p-8 bg-red-500/5 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-red-500 text-xs px-3 py-1 rounded-full">EARLY ACCESS</div>
            <div className="text-xs uppercase tracking-wider text-red-400 mb-2">Pro</div>
            <div className="text-4xl font-bold mb-2">Soon</div>
            <div className="text-sm text-zinc-500 mb-6">early backers shape pricing</div>
            <ul className="space-y-3 text-sm text-zinc-300 mb-8">
            ...
            {waitlistStatus === "success" ? (
              <div className="w-full py-3 text-center text-sm text-green-400 border border-green-500/30 rounded-lg bg-green-500/5">
                You&apos;re in. I&apos;ll email when Pro opens.
              </div>
            ) : (
